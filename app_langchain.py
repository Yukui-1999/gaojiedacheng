...
def generate_travel_script(destination, days, budget, detail_level, randomness):
    ...
    config_file_path = r'/data/home/Zhifan/gaojiedacheng/config/base_config.py'
    new_keyword = script
    ...
    conda_env_python = r'/data/home/Zhifan/anaconda3/envs/travelplan/bin/python'
    if not os.path.isfile(conda_env_python):
        raise FileNotFoundError(f"Python interpreter not found: {conda_env_python}")
    main_py_path = r'/data/home/Zhifan/gaojiedacheng/main.py'  # 替换为你的 main.py 的实际绝对路径
    ...
    directory = r"/data/home/Zhifan/gaojiedacheng/data/xhs"  # 替换为你的目录路径
